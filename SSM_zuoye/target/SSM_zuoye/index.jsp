...
<div align="center"><font size="20px">登录界面</font></div>
<hr size="3px" color="red" width="100%"/>
...
<form action="${pageContext.request.contextPath}/student/login.do">
    <table align="center" width="600px" bgcolor="#7fffd4" height="320px">
        <tr><th colspan="600px" height="120px" align="center"><font size="5px" color="darkred">登录界面</font></th></tr>
        ...
        <tr><th width="260px" height="40px" align="right"><input type="submit" value="登录"></th><th width="118px" align="right" ><input type="reset"  value="注册" onclick='location.href=("zhuce.jsp")'></th><th></th><th></th></tr>
